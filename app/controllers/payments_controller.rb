class PaymentsController < ApplicationController
  ...
  def update
    ...
    # EFFACE PAYMENT - on efface la dette du payeur et l'incrementation du total du budget
    ...
    # RECREE PAYMENT - on met à jour la dette du payeur et on incremente le total du budget
